...
TerrainGridGraph::TerrainGridGraph(int columns, int rows, float cellSize, bool isDirectionalGraph, bool isConnectedDiagonally, float costStraight, float costDiagonal)
