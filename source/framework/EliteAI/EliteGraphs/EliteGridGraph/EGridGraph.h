...
namespace Elite
{
	...
	public:
		...
		GridGraph(int columns, int rows, float cellSize, bool isDirectionalGraph, bool isConnectedDiagonally, float costStraight = 1.f, float costDiagonal = 1.5, GraphNodeFactory* factory = nullptr, ConnectionCostCalculator* pCostCalculator =nullptr);
		virtual ~GridGraph();
